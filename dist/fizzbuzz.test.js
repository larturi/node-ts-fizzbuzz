...
describe('fizzbuzz()', () => {
    ...
    it('muestra en pantalla los 100 primeros:', () => {
        ...
        for (let i = 0; i < 100; i++) {
            arrayFizzBuzz.push(fizzbuzz_1.default(i + 1, 3, 5));
        }
